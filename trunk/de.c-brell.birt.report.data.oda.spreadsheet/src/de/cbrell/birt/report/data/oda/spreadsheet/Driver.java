...
{
    public static String ODA_DATA_SOURCE_ID = "de.c-brell.birt.report.data.oda.spreadsheet";  //$NON-NLS-1$
    public static String ODA_DATA_SET_ID = "de.c-brell.birt.report.data.oda.spreadsheet.dataSet";
	...
	public IConnection getConnection( String dataSourceType ) throws OdaException {
		return new SpreadsheetConnection();
	}
